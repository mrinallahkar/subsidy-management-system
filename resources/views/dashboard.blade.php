                                ...
                                <table style="width:100%">
                                    <tr>
                                        ...
                                        <td style="text-align: left;">Year:
                                            <select style="width:150px; text-align:left;" name="category_id" class="btn btn-secondary dropdown-toggle chosen" onchange="getDashboardOnYearChange(this.value,'{{url('get-dashboard-values-onChange')}}');">
                                                <option value="">--Select Year--</option>
                                                @foreach($finYear as $finYear2)
                                                <option value="{{$finYear2->Received_Date}}">{{$finYear2->Received_Date}}</option>
                                                @endforeach
                                            </select>
                                        </td>
...
{!! Html::script('/assets/tableExport/jspdf/1.5.3/jspdf.min.js') !!}
