    ...
    <div class="row w-100">
        <div class="col-lg-4 mx-auto">
            ...
            <div class="auto-form-wrapper">
                ...
                <br>
                <span class="card-title text-center" style="margin-left:0px; font-size:.8em; color:#205a9e; font-family:Verdana, Geneva, Tahoma, sans-serif">New password has been generated and sent to the registered email address.<span>
