        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:right;">
                    ...
                    <button type="button" data-toggle="modal" data-target="#editModal" class="btn btn-dark btn-sm" onclick="addModalMaster('{{$schemeMaster->Pkid}}','{{url('view-edit-scheme-master')}}','viewEditModal',this,'EDT','Scheme Master');"> <i class="mdi mdi-grease-pencil"></i>Edit </button>
                    ...
                    @else
                    <button type="button" disabled data-toggle="modal" data-target="#editModal" class="btn btn-dark btn-sm" onclick="addModalMaster('{{$schemeMaster->Pkid}}','{{url('view-edit-scheme-master')}}','viewEditModal',this,'EDT','Scheme Master');"> <i class="mdi mdi-grease-pencil"></i>Edit </button>
