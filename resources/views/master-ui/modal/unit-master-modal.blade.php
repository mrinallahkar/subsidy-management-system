...
<div style="width: 60%; text-align:left" class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h6 class="modal-title"><i class="mdi mdi mdi-plus"></i>Add Unit Master</h6>
                                    ...
                                    <div id="returnModel">
                                        ...
                                        <table class="table table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="text" name="Unit_Name" id="Unit_Name" class="form-control"></td>
                                                    <td><textarea type="text" name="Description" id="Description" class="form-control"></textarea></td>
                                                </tr>
                                                <tr>
