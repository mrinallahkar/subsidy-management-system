                                                    ...
                                                    <table id="dataTable" width="100%" style="font-size:9pt;" class="table1 table-bordered" cellpadding="5">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="12%"> SLC Date </th>
                                                                <th width="12%"> App. Date </th>
                                                                <th width="15%"> Claim Period </th>
                                                                <th width="13%" style="text-align:right;"> Claim Amount </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @php
                                                            ...
                                                            @if ($groupby=='State Wise')
                                                                ...
                                                                @if ($loop->iteration>1)
                                                                <tr>
                                                                    <th colspan="7" class="text-right">Sub Total Rs.:</th>
                                                                ...
                                                                <tr>
                                                                    <td colspan="8" style="background: #CCC; font-weight:bold;">{{$smsClaimMaster->State_Name}}</td>
                                                                </tr>
                                                                @endif
                                                            @endif
                                                            ...
                                                            @if($smsClaimMaster->Scheme_Name!=$scheme)
                                                                ...
                                                                <tr>
                                                                    <td colspan="8" style="background: #CCC; font-weight:bold;">{{$smsClaimMaster->Scheme_Name}}</td>
                                                                </tr>
                                                                @endif
                                                            @endif
                                                            @php $count=$count+1; @endphp
                                                            @php $sub_total=$sub_total+$smsClaimMaster->Claim_Amt; @endphp
                                                            <tr>
                                                                <td>{{$count}} </td>
                                                                ...
                                                                <td align="right"> {{number_format($smsClaimMaster->Claim_Amt,2)}} </td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <th colspan="7" class="text-right">Grand Total Rs.:</th>
