                                                ...
                                                <div class="table-responsive" style="overflow: hidden; outline: none;" tabindex="0">
                                                    <table id="dataTable" width="100%" style="font-size:9pt;" class="table1 table-bordered" cellpadding="5">
                                                        <thead>
                                                            <tr>
                                                                <th width="5%"> # </th>
                                                                <th width="35%"> {{$groupby}} </th>
                                                                <th width="30%" style="text-align:right;"> Claim Amount </th>
                                                                <th width="30%" style="text-align:right;"> Pending Amount </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="text-right">{{number_format($smsClaimMaster->Claim_Amt-$smsClaimMaster->Balance,2)}}</th>
                                                            </tr>
                                                            @php $total=$total+$smsClaimMaster->Claim_Amt; @endphp
                                                            @php $balance=$balance+(($smsClaimMaster->Claim_Amt-$smsClaimMaster->Balance)); @endphp
                                                            @endforeach
