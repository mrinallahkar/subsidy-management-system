<script>
    $("#generateCompositReport").submit(function() {
        return false;
    });
</script>
<div id="ajaxLoadPage">
                ...
                <div class="card-body">
                        ...
                        <table style="width:100%">
                            <tr>
                                <td colspan="2" class="card-title" style="text-align: left;"><i class="menu-icon mdi mdi-account-box-multiple text-danger mdi-elevation-rise"></i>
                                    <span class="menu-title" style="font-weight: bold;">Composit Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                    ...
                    margin: 0 0 1.5em 0 !important; -webkit-box-shadow:  0px 0px 0px 0px #000; box-shadow:  0px 0px 0px 0px #000;">
                        ...
                        width:auto; padding:0 2px;border-bottom:none;"><i class="mdi mdi-magnify"></i>
                            ...
                            <div class="table-responsive">
                                <form id="generateCompositReport" method="POST">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="header">
                                                <td colspan="4" align="center">
                                                    <button type="submit" class="btn btn-primary btn-fw" id="searchBtn" onclick="searchWithInput(this,'{{url('report-ui.generate-composit-report')}}','searchResult','generateCompositReport','benificiary_name');">
                                                    ...
                                                    <button id="btnPrint" type="button" disabled onclick="printDiv('searchResult','Composit Report');" class="btn btn-primary hidden-print">
