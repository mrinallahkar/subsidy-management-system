                                                        ...
                                                        <tbody>
                                                            ...
                                                            @if($groupby=='State Wise')
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th colspan="2" class="text-right">{{number_format($sub_total,2)}}</th>
                                                                </tr>
                                                                @endif
                                                            ...
                                                            @if($smsCompositReport->Scheme_Name!=$scheme)
                                                                @if ($loop->iteration>1)
                                                                <tr>
                                                                    <th colspan="15" class="text-right">Sub Total Rs.:</th>
                                                                    <th colspan="2" class="text-right">{{number_format($sub_total,2)}}</th>
                                                                ...
                                                                @endif
                                                                @php $scheme=$smsCompositReport->Scheme_Name; @endphp
                                                                @php $count=0; @endphp
                                                                @php $sub_total=0; @endphp
                                                                <tr>
                                                                    <td colspan="17" style="background: #CCC; font-weight:bold;">{{$smsCompositReport->Scheme_Name}}</td>
                                                                </tr>
                                                                @endif
                                                            @endif
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> {{number_format($smsCompositReport->Approved_Raw_Materials,2)}} </td>
                                                                <td> {{number_format($smsCompositReport->Approved_Finish_Goods,2)}} </td>
                                                                <td> {{$smsCompositReport->Instrument_No}}</td>
                                                                <td> {{date('d-m-Y', strtotime($smsCompositReport->Instrument_Date))}}</td>
                                                                <td align="right"> {{number_format($smsCompositReport->Disbursement_Amt,2)}} </td>
