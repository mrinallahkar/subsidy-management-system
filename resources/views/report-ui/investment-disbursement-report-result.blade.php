                                                    ...
                                                    <table id="dataTable" class="table1 table-bordered" cellpadding="5" style="font-size:9pt;" width="100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right"> {{number_format($smsClaimMaster->Disbursement_Amt,3)}} </td>
                                                                @php $total=$total+$smsClaimMaster->Disbursement_Amt; @endphp
                                                            </tr>
                                                            @if ($length==$loop->iteration)
                                                            <tr>
                                                                <th colspan="10" class="text-right">Sub Total Rs.:</th>
                                                                <th class="text-right">{{number_format($sub_total,3)}}</th>
                                                            </tr>
                                                            @endif
                                                            @empty
                                                            <tr>
                                                                <td colspan="11" align="center" width="100%">No Records Found !!</td>
                                                            </tr>
                                                            @endforelse
                                                        </tbody>
                                                        <tfoot>
                                                            <tr>
                                                                <th colspan="10" class="text-right">Grand Total Rs.:</th>
