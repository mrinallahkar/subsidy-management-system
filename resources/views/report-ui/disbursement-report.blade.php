<script>
    $("#generateDisbursementReport").submit(function() {
        return false;
    });
</script>
<div id="ajaxLoadPage">
                ...
                <div class="card-body">
                        ...
                        <table style="width:100%">
                            <tr>
                                <td colspan="2" class="card-title" style="text-align: left;"><i class="menu-icon mdi mdi-account-box-multiple text-danger mdi-elevation-rise"></i>
                                    <span class="menu-title" style="font-weight: bold;">Disbursement Report</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                    ...
                    margin: 0 0 1.5em 0 !important; -webkit-box-shadow:  0px 0px 0px 0px #000; box-shadow:  0px 0px 0px 0px #000;">
                        ...
                        width:auto; padding:0 2px;border-bottom:none;"><i class="mdi mdi-magnify"></i>
                            ...
                            <div class="table-responsive">
                                <form id="generateDisbursementReport" method="POST">
                                    <table class="table table-hover" style="border: 1px solid #ababab;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <label for="" class="col-sm-2 form-control-label">Payment From Date</label>
                                                    <div class="col-sm-10" aria-colspan="2">
                                                        <input class="form-control" type="date" id="from_date" name="from_date" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <label for="" class="col-sm-2 form-control-label">Payment To Date</label>
                                                    <div class="col-sm-10" aria-colspan="2">
                                            ...
                                            <tr class="header">
                                                <td colspan="4" align="center">
                                                    <button type="submit" class="btn btn-primary btn-fw" id="searchBtn" onclick="searchWithInput(this,'{{url('report-ui.generate-disbursement-report')}}','searchResult','generateDisbursementReport','benificiary_name');">
                                                    ...
                                                    <button id="btnPrint" type="button" disabled onclick="printDiv('searchResult','Disbursement Report');" class="btn btn-primary hidden-print">
