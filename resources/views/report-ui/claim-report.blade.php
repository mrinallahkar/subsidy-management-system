                         ...
                         <table style="width:100%">
                             <tr>
                                 <td colspan="2" class="card-title" style="text-align: left;"><i class="menu-icon mdi mdi-account-box-multiple text-danger mdi-elevation-rise"></i>
                                     <span class="menu-title" style="font-weight: bold;">Claim Received Report</span>
                                 </td>
                             </tr>
                             <tr>
                                 <td colspan="2">
                                         ...
                                         <tbody>
                                             ...
                                             <tr class="header">
                                                 <td colspan="4" align="center">
                                                     <button type="submit" class="btn btn-primary btn-fw" id="searchBtn" onclick="searchWithInput(this,'{{url('report-ui.generate-claim-report')}}','searchResult','generateClaimReport','benificiary_name');">
                                                         <i class="mdi mdi-magnify"></i>Generate</button>
                                                     <button type="button" class="btn btn-primary hidden-print" onclick="printDiv('searchResult','Claim Received Report');">
