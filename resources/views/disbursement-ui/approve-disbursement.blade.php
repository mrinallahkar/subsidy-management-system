...
<div id="ajaxLoadPage">
    ...
    <form method="POST" id="disbursementApproveForm">
        <div class="row">
                            ...
                            <table style="width:100%">
                                <tr>
                                    <td colspan="2" class="card-title" style="text-align: left;"><i class="menu-icon mdi mdi-receipt text-warning icon-sm"></i>
                                        <span class="menu-title" style="font-weight: bold;">Approve Disbursement</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                            ...
                            <table id="example"  class="display table table-striped table-bordered no-footer" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="5%"> ID </th>
                                            <th width="30%"> Benificiary Name </th>
                                            <th width="14%"> Disbursement Date </th>
                                            ...
                                            <!-- <th> Status </th> -->
                                            <th width="9%" style="text-align:right;"> Action </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <button title="View Record" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#viewDisbursement" onclick="viewDisbursementModel('{{$disbursementDetailList->Pkid}}','{{$disbursementDetailList->Claim_Id_Pk}}','{{ url('view-disbursement-details-modal') }}','appendDisbursement','VIW','Disbursement Details','disbursementSearchResult');">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr class="header">
                                        <td colspan="6" align="center">
                                            <button type="button" class="btn btn-success btn-fw" onclick="fnCmnApproved('{{ url('approve-disbursement') }}', 'disbursementApproveForm','approvalList');">
