            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table style="width:100%">
                        <tr>
                            <td colspan="2" class="card-title" style="text-align: left; font-weight:bold">Subsidy Fund List:
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                    ...
                    <table id="example" class="display table table-striped table-bordered no-footer" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th> Sanction Date </th>
                                <th> Scheme </th>
                                <th align="right"> Sanction Amount </th>
                                <th> Status </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <button title="View Record" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#viewSubsidyFund" onclick="viewModel({{$subsidyFund->Pkid}},'{{ url('view-edit-subsidy-fund') }}','appendSubsidyFund','VIW','Subsidy Fund');">
