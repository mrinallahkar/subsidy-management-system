...
<div id="ajaxLoadPage">
    ...
    <form method="POST" id="fundAllocationApproveForm">
        <div class="row">
                            ...
                            <table style="width:100%">
                                <tr>
                                    <td colspan="2" class="card-title" style="text-align: left;"><i class="menu-icon mdi mdi-poll-box text-success icon-sm"></i>
                                        <span class="menu-title" style="font-weight: bold;">Approve Fund Allocation</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                            ...
                            <table id="example"  class="display table table-striped table-bordered no-footer" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="30%"> Sanction Letter </th>
                                            <th width="19%"> Scheme </th>
                                            <th width="17%"style="text-align:right;"> Sanction Amount </th>
                                            <th width="17%"style="text-align:right;"> Allocated Amount </th>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr class="header">
                                        <td colspan="6" align="center">
                                            <button type="button" class="btn btn-success btn-fw" onclick="fnCmnApproved('{{ url('approve-subsidy-fund-allocation') }}', 'fundAllocationApproveForm','approvalList');">
            ...
            <div style="width: 80%; text-align:left" class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h6 class="modal-title"><i class="mdi mdi-view-carousel"></i>View Fund Allocation</h6>
