 ...
 * @package App\Models
 */
class TbCmnModuleMaster extends Model
{
	protected $table = 'tb_cmn_module_master';
	...
	{
		return $this->hasMany(TbCmnRoleAccess::class, 'Module_Id_Fk');
	}
}
