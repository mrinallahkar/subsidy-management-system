 ...
 * @property Carbon|null $Instrument_Date
 ...
 * @package App\Models
 */
class TbSmsDisbursementDetail extends Model
{
	protected $table = 'tb_sms_disbursement_details';
